...
vim.api.nvim_set_keymap('n', '<leader>t', ':belowright split | terminal<CR>', { noremap = true, silent = true }) --Open a terminal at the bottom with <leader>t
...
keymap.set("v", "J", ":m '>+1<CR>gv=gv") -- move selected line together keymap.set("v", "K", ":m '<-2<CR>gv=gv") -- move selected line together
